...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: Product): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async seedProducts(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: string, arg1: bigint, arg2: Product): Promise<boolean> {
        if (this.processError) {
            try {
